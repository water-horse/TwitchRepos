package com.waterhorse.twitch.dao;

import com.waterhorse.twitch.entity.db.Item;
import com.waterhorse.twitch.entity.db.ItemType;
...
public class FavoriteDao {
    ...
    // The returned map includes three entries like {"Video": [item1, item2, item3], "Stream": [item4, item5, item6], "Clip": [item7, item8, ...]}
